...
BEGIN
  ...
  ON CONFLICT (slug) DO UPDATE
    SET name = EXCLUDED.name, parent_id = NULL, position = EXCLUDED.position, active = true, show_in_menu = true
  ...
  ON CONFLICT (slug) DO UPDATE
    SET name = EXCLUDED.name, parent_id = EXCLUDED.parent_id, position = EXCLUDED.position, active = true, show_in_menu = true;
END $$;